...
public class FlywaySchemaHistory extends TableImpl<FlywaySchemaHistoryRecord> {
     ...
     * <code>DEFAULT_SCHEMA.flyway_schema_history</code>
     */
    ...
    /**
     * The column
     * <code>DEFAULT_SCHEMA.flyway_schema_history.installed_rank</code>.
     */
    ...
    /**
     * The column <code>DEFAULT_SCHEMA.flyway_schema_history.version</code>.
     */
    public final TableField<FlywaySchemaHistoryRecord, String> VERSION = createField(DSL.name("version"), SQLDataType.VARCHAR(4194304), this, "");

    /**
     * The column <code>DEFAULT_SCHEMA.flyway_schema_history.description</code>.
     */
    public final TableField<FlywaySchemaHistoryRecord, String> DESCRIPTION = createField(DSL.name("description"), SQLDataType.VARCHAR(4194304), this, "");

    /**
     * The column <code>DEFAULT_SCHEMA.flyway_schema_history.type</code>.
     */
    public final TableField<FlywaySchemaHistoryRecord, String> TYPE = createField(DSL.name("type"), SQLDataType.VARCHAR(4194304), this, "");

    /**
     * The column <code>DEFAULT_SCHEMA.flyway_schema_history.script</code>.
     */
    public final TableField<FlywaySchemaHistoryRecord, String> SCRIPT = createField(DSL.name("script"), SQLDataType.VARCHAR(4194304), this, "");

    /**
     * The column <code>DEFAULT_SCHEMA.flyway_schema_history.checksum</code>.
     */
    ...
    /**
     * The column
     * <code>DEFAULT_SCHEMA.flyway_schema_history.installed_by</code>.
     */
    public final TableField<FlywaySchemaHistoryRecord, String> INSTALLED_BY = createField(DSL.name("installed_by"), SQLDataType.VARCHAR(4194304), this, "");

    /**
     * The column
     * <code>DEFAULT_SCHEMA.flyway_schema_history.installed_on</code>.
     */
    public final TableField<FlywaySchemaHistoryRecord, LocalDateTime> INSTALLED_ON = createField(DSL.name("installed_on"), SQLDataType.LOCALDATETIME(19), this, "", new DatetimeBinding());

    /**
     * The column
     * <code>DEFAULT_SCHEMA.flyway_schema_history.execution_time</code>.
     */
    public final TableField<FlywaySchemaHistoryRecord, Integer> EXECUTION_TIME = createField(DSL.name("execution_time"), SQLDataType.INTEGER, this, "");

    /**
     * The column <code>DEFAULT_SCHEMA.flyway_schema_history.success</code>.
     */
    public final TableField<FlywaySchemaHistoryRecord, Boolean> SUCCESS = createField(DSL.name("success"), SQLDataType.BOOLEAN, this, "");
    ...
    /**
     * Create an aliased <code>DEFAULT_SCHEMA.flyway_schema_history</code> table
     * reference
     */
    ...
    /**
     * Create a <code>DEFAULT_SCHEMA.flyway_schema_history</code> table
     * reference
     */
