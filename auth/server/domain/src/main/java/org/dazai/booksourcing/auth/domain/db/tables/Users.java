...
public class Users extends TableImpl<UsersRecord> {
    ...
    /**
     * The reference instance of <code>DEFAULT_SCHEMA.users</code>
     */
    ...
    /**
     * The column <code>DEFAULT_SCHEMA.users.id</code>.
     */
    public final TableField<UsersRecord, Long> ID = createField(DSL.name("id"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DEFAULT_SCHEMA.users.username</code>.
     */
    public final TableField<UsersRecord, String> USERNAME = createField(DSL.name("username"), SQLDataType.VARCHAR(4194304).nullable(false), this, "");

    /**
     * The column <code>DEFAULT_SCHEMA.users.password</code>.
     */
    public final TableField<UsersRecord, String> PASSWORD = createField(DSL.name("password"), SQLDataType.VARCHAR(4194304).nullable(false), this, "");

    /**
     * The column <code>DEFAULT_SCHEMA.users.is_disabled</code>.
     */
    public final TableField<UsersRecord, Boolean> IS_DISABLED = createField(DSL.name("is_disabled"), SQLDataType.BOOLEAN.nullable(false), this, "");
    ...
    /**
     * Create an aliased <code>DEFAULT_SCHEMA.users</code> table reference
     */
    ...
    /**
     * Create a <code>DEFAULT_SCHEMA.users</code> table reference
     */
    public Users() {
