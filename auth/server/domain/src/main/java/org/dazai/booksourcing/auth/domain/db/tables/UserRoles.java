...
public class UserRoles extends TableImpl<UserRolesRecord> {
    ...
    /**
     * The reference instance of <code>DEFAULT_SCHEMA.user_roles</code>
     */
     ...
     */
    public final TableField<UserRolesRecord, String> ROLE = createField(DSL.name("role"), SQLDataType.VARCHAR(4194304).nullable(false), this, "");
    ...
    /**
     * Create an aliased <code>DEFAULT_SCHEMA.user_roles</code> table reference
     */
    ...
    /**
     * Create a <code>DEFAULT_SCHEMA.user_roles</code> table reference
     */
    public UserRoles() {
